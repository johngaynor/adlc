...
a `.claude/lessons/` directory, and a `.ai/specs/` directory — a strong starting
point you grow from. It can also optionally connect the repo to Linear, which
unlocks the lifecycle below.
